 ...
 * @date 2020/07/06
 */
@ApiModel(description = "动态数据表查询VO")
@Data
@Accessors(chain = true)
public class DynamicTableVO implements Serializable {
    ...
    @NotNull(message = "查询条件（tableVO）不能为null", groups = {ValidationGroup_Add.class, ValidationGroup_Update.class})
    @ApiModelProperty(value = "查询条件",name = "tableVO", required = true,example = "")
