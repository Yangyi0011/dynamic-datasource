 ...
 * @date 2020/07/06
 */
@ApiModel(description = "动态数据库查询VO")
@Data
@Accessors(chain = true)
public class DynamicDataBaseVO implements Serializable {
    ...
    @NotNull(message = "查询条件（dataBaseVO）不能为null", groups = {ValidationGroup_Add.class, ValidationGroup_Update.class})
    @ApiModelProperty(value = "查询条件",name = "dataBaseVO", required = true,example = "")
